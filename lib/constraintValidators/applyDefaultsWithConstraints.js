...
var applyDefaults = function applyDefaults(defaults) {
  return (0, _ramda.compose)(Success, (0, _ramda.reduce)(function (acc, _ref) {
    ...
    return (0, _ramda.unless)((0, _ramda.has)(name), (0, _ramda.assoc)(name, defaultValue))(acc);
  }, _ramda.__, (0, _ramda.toPairs)(defaults)));
};

exports.default = function (constraints) {
  return (0, _ramda.ifElse)(_ramdaAdjunct.isNotEmpty, applyDefaults, (0, _ramda.always)(Success))((0, _utils.defaultsMap)(constraints));
};